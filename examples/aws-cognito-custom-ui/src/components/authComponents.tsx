...
export const Email: React.FunctionComponent<{ emailIsValid: boolean; setEmail: (_: string) => void }> = ({ emailIsValid, setEmail }) => {
  return (
    <TextField
      fullWidth
      variant="outlined"
...
export const Code: React.FunctionComponent<{ codeIsValid: boolean; setCode: (_: string) => void }> = ({ codeIsValid, setCode }) => {
  return (
    <TextField
      fullWidth
      variant="outlined"
