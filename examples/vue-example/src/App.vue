        ...
        <div class="grid grid-cols-8 gap-0">
          ...
          <Card class="px-4 py-4 gird col-span-2">
            ...
            <div class="mb-4">
              <Button :class="['w-full !h-auto group py-3 rounded-full flex items-center justify-center']" type="button"
                block size="md" pill @click="getUserInfo">
                Get user info
              </Button>
            </div>
            <div class="mb-4">
              <Button :class="['w-full !h-auto group py-3 rounded-full flex items-center justify-center']" type="button"
                block size="md" pill @click="getOpenloginState">
                Get openlogin state
              </Button>
            </div>
            <div class="mb-4">
              <Button :class="['w-full !h-auto group py-3 rounded-full flex items-center justify-center']" type="button"
                block size="md" pill @click="getEd25519Key">
                Get Ed25519Key
              </Button>
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
              <Button :class="['w-full !h-auto group py-3 rounded-full flex items-center justify-center']" type="button"
                block size="md" pill :disabled="!ethereumPrivateKeyProvider?.provider" @click="signMessage">
                Sign test Eth Message
              </Button>
            </div>
            <div class="mb-4">
              <Button :class="['w-full !h-auto group py-3 rounded-full flex items-center justify-center']" type="button"
                block size="md" pill :disabled="!ethereumPrivateKeyProvider?.provider" @click="signMpcMessage">
                Sign test Eth Message (MPC)
              </Button>
            </div>
            <div class="mb-4">
              <Button :class="['w-full !h-auto group py-3 rounded-full flex items-center justify-center']" type="button"
                block size="md" pill :disabled="!ethereumPrivateKeyProvider?.provider" @click="latestBlock">
                Fetch latest block
              </Button>
            </div>
            <div class="mb-4">
              <Button :class="['w-full !h-auto group py-3 rounded-full flex items-center justify-center']" type="button"
                block size="md" pill :disabled="!ethereumPrivateKeyProvider?.provider" @click="addChain">
                Add Sepolia
              </Button>
            </div>
            <div class="mb-4">
              <Button :class="['w-full !h-auto group py-3 rounded-full flex items-center justify-center']" type="button"
                block size="md" pill :disabled="!ethereumPrivateKeyProvider?.provider" @click="switchChain">
                Switch to Sepolia
              </Button>
            </div>
            <div class="mb-4">
              <Button :class="['w-full !h-auto group py-3 rounded-full flex items-center justify-center']" type="button"
                block size="md" pill :disabled="!ethereumPrivateKeyProvider?.provider" @click="signV1Message">
          ...
          <Card id="console" class="px-4 py-4 col-span-4 overflow-y-auto">
            ...
            <div class="absolute top-2 right-8">
              <Button :class="['w-full !h-auto group py-3 rounded-full flex items-center justify-center']" type="button"
                block size="md" pill @click="clearConsole">
                Clear console
              </Button>
            </div>
          </Card>
        ...
        <Card class="h-auto px-12 py-16 col-span-8 sm:col-span-6 lg:col-span-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-5">
            ...
            <Card v-if="isWhiteLabelEnabled" :shadow="false" :border="isWhiteLabelEnabled"
              ...
              <div class="mt-3">
                <TextField v-model="whitelabelConfig.appName" class="mt-3" label="Enter App Name"
                  aria-label="Enter App Name" placeholder="Enter App Name" />
              </div>
              <div class="mt-3">
              ...
              <div class="mt-3">
                <Select v-model="whitelabelConfig.defaultLanguage" class="mt-3" label="Select Language*"
          ...
          <div class="flex justify-center mt-5">
            <Button :class="['w-full !h-auto group py-3 rounded-full flex items-center justify-center']"
              :disabled="!isLoginHintAvailable" type="button" block size="md" pill @click="login">
